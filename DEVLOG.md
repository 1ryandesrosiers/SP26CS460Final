...
One wrong assumption I made when completing this project was when I was initially trying to implement find_optimal_route, I didn't know the helper function was defined just below it. So I was creating my own, additional helper function. Once I realized that was not needed, I had to scrap that code and start fresh using the provided helper function. Even though I had to go backwards a little, using the provided helper function cleared a lot of my confusion. 
...
## Final Entry – 05/10/26: Time Estimate
